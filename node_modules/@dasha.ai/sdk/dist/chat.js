...
async function createChat(accountOrConversation, options) {
    ...
    if (accountOrConversation === undefined || "apiKey" in accountOrConversation) {
        ...
        return new Chat(account !== null && account !== void 0 ? account : (await account_1._getEffectiveAccount({ _log: log_1.log })));
    }
    const conversation = accountOrConversation;
    return new Chat((_a = options === null || options === void 0 ? void 0 : options.account) !== null && _a !== void 0 ? _a : (await account_1._getEffectiveAccount({ _log: log_1.log })), conversation);
}
...
async function createConsoleChat(accountOrConversation, options) {
    ...
    if (accountOrConversation === undefined || "apiKey" in accountOrConversation) {
        const account = accountOrConversation;
        return new ConsoleChat(account !== null && account !== void 0 ? account : (await account_1._getEffectiveAccount({ _log: log_1.log })));
    }
    const conversation = accountOrConversation;
    return new ConsoleChat((_a = options === null || options === void 0 ? void 0 : options.account) !== null && _a !== void 0 ? _a : (await account_1._getEffectiveAccount({ _log: log_1.log })), conversation);
}
