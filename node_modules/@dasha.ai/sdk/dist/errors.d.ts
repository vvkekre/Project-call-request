 ...
 * @module
 */
import { ProfilerRequest } from "./rest-api";
...
export declare class AudioRoomDisconnectedError extends Error {
    roomId: string;
    details: string;
    name: string;
    constructor(roomId: string, details: string);
}
export declare class AudioRoomForbiddenError extends Error {
    roomId: string;
    details: string;
    name: string;
    constructor(roomId: string, details: string);
}
export declare class AudioRoomNotFoundError extends Error {
    roomId: string;
    details: string;
    name: string;
    constructor(roomId: string, details: string);
...
export declare class ApplicationNotFoundError extends Error {
...
export declare class TtsNotFoundError extends Error {
    name: string;
    constructor(message: string);
}
export declare class TtsSpeakerNotFoundError extends Error {
    name: string;
    constructor(message: string);
}
export declare class TtsSpeakerCloneWrongFile extends Error {
    name: string;
    constructor();
}
export declare class ProfilerDataFailedError extends Error {
    request: ProfilerRequest;
    name: string;
    constructor(request: ProfilerRequest);
}
