 ...
 */
export declare type TtsProviderName = "default" | "custom" | "dasha" | "voice-cloning" | "dasha-emotional";
/**
...
export declare type CustomTtsSpeaker = {
    name: string;
    createdTime: Date;
    lastUpdatedTime: Date;
};
export declare function getCustomSpeakers(options?: {
    account?: Account;
}): Promise<CustomTtsSpeaker[]>;
export declare function getCustomSpeakerByName(name: string, options?: {
    account?: Account;
}): Promise<CustomTtsSpeaker>;
export declare function deleteCustomSpeakerByName(name: string, options?: {
    account?: Account;
}): Promise<void>;
export declare function addOrUpdateCustomSpeakerByName(name: string, voiceFileContent: Uint8Array, options?: {
    account?: Account;
}): Promise<CustomTtsSpeaker>;
