...
export declare type InstanceStream = base.Stream<{
...
export declare type RuntimeStream = base.Stream<{
    error: [error: errors.Error];
    rpcRequest: [request: RpcRequest];
}>;
export declare type DebugStream = base.Stream<{
    error: [error: errors.Error];
    jobEvent: [jobId: string, event: unknown];
    debugLog: [jobId: string, message: string];
}>;
export declare type AudioServerStream = base.Stream<{
    error: [error: errors.Error];
    connect: [audioClientId: number, additionalInfo: string];
}>;
export declare type AudioClientStream = base.Stream<{
    error: [error: errors.Error];
    inviteRequest: [audioClientId: number, additionalInfo: string, roomId?: string];
}>;
export declare class ProcessingClient extends base.Client<sdk_grpc_pb.ProcessingClient> {
