...
async function createGroup(name, info, options) {
    var _a;
    ...
    const group = await api.createGroup({ name, ...info });
...
*/
async function deleteGroup(name, options) {
    var _a;
    const account = (_a = options === null || options === void 0 ? void 0 : options.account) !== null && _a !== void 0 ? _a : (await account_1._getEffectiveAccount({ _log: log_1.log }));
    const log = log_1.log.child({ account: account_1.anonymizeAccount(account) });
    const api = new rest.GroupApi(account, log);
    await api.deleteGroup(name, options);
}
 ...
 *   defaults to the {@link getCurrentAccountName | current account}
*/
async function getGroupByName(name, options) {
    var _a;
    const account = (_a = options === null || options === void 0 ? void 0 : options.account) !== null && _a !== void 0 ? _a : (await account_1._getEffectiveAccount({ _log: log_1.log }));
    const log = log_1.log.child({ account: account_1.anonymizeAccount(account) });
    const api = new rest.GroupApi(account, log);
    const group = await api.getGroupByName(name);
    return toGroupInfo(group);
}
 ...
 *   defaults to the {@link getCurrentAccountName | current account}
*/
async function updateGroup(name, info, options) {
    var _a;
    const account = (_a = options === null || options === void 0 ? void 0 : options.account) !== null && _a !== void 0 ? _a : (await account_1._getEffectiveAccount({ _log: log_1.log }));
    const log = log_1.log.child({ account: account_1.anonymizeAccount(account) });
    const api = new rest.GroupApi(account, log);
    const group = await api.updateGroup(name, info);
    return toGroupInfo(group);
}
