...
const RecordApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        apiV1RecordsRecordIdGet: async (recordId, type, inBrowser, options = {}) => {
...
const RecordApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1RecordsRecordIdGet(recordId, type, inBrowser, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1RecordsRecordIdGet(recordId, type, inBrowser, options);
