...
const SttApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        apiV1SttGroupsGet: async (names, skip, take, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        apiV1SttGroupsIdGet: async (id, options = {}) => {
...
const SttApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiV1SttGroupsGet(names, skip, take, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1SttGroupsGet(names, skip, take, options);
         ...
         * @throws {RequiredError}
         */
        async apiV1SttGroupsIdGet(id, options) {
            const localVarAxiosArgs = await localVarAxiosParamCreator.apiV1SttGroupsIdGet(id, options);
            return common_1.createRequestFunction(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration);
        },
    };
};
