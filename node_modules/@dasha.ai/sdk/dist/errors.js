...
exports.ProfilerDataFailedError = exports.TtsSpeakerCloneWrongFile = exports.TtsSpeakerNotFoundError = exports.TtsNotFoundError = exports.TtsDispatcherError = exports.TimeoutError = exports.SttDispatcherError = exports.SipConfigNotFoundError = exports.SipConfigExistsError = exports.OptionalDependencyNotFoundError = exports.NotImplementedError = exports.InternalError = exports.ApplicationNotFoundError = exports.GroupNotFoundError = exports.GroupExistsError = exports.FileSystemError = exports.ExternalResultNotSerializableError = exports.ExternalNotFoundError = exports.DeploymentError = exports.CustomTtsProviderError = exports.ConversationRejectedError = exports.ConversationError = exports.ConnectionProviderError = exports.ConnectionError = exports.CancelError = exports.PermissionError = exports.AuthenticationError = exports.AudioRoomNotFoundError = exports.AudioRoomForbiddenError = exports.AudioRoomDisconnectedError = exports.AudioError = exports.ArgumentError = exports.AccountNotFoundError = exports.AccountExistsError = exports.Error = void 0;
...
class AudioRoomDisconnectedError extends Error {
    constructor(roomId, details) {
        super(`audio room ${roomId} disconnected: ${details}`);
        this.roomId = roomId;
        this.details = details;
        this.name = "dasha.AudioRoomDisconnectedError";
    }
}
exports.AudioRoomDisconnectedError = AudioRoomDisconnectedError;
class AudioRoomForbiddenError extends Error {
    constructor(roomId, details) {
        super(`audio room ${roomId} forbidden: ${details}`);
        this.roomId = roomId;
        this.details = details;
        this.name = "dasha.AudioRoomForbiddenError";
    }
}
exports.AudioRoomForbiddenError = AudioRoomForbiddenError;
class AudioRoomNotFoundError extends Error {
    constructor(roomId, details) {
        super(`audio room ${roomId} not found: ${details}`);
        this.roomId = roomId;
        this.details = details;
        this.name = "dasha.AudioRoomNotFoundError";
    }
}
exports.AudioRoomNotFoundError = AudioRoomNotFoundError;
...
class PermissionError extends Error {
    constructor(message) {
        super(message);
        this.name = "dasha.PermissionError";
    }
}
...
class ApplicationNotFoundError extends Error {
    constructor(applicationId) {
        ...
        this.name = "dasha.ApplicationNotFoundError";
    }
}
...
class TtsNotFoundError extends Error {
    constructor(message) {
        super(`TTS not found: ${message}`);
        this.name = "dasha.TtsNotFoundError";
    }
}
exports.TtsNotFoundError = TtsNotFoundError;
class TtsSpeakerNotFoundError extends Error {
    constructor(message) {
        super(`TTS Speaker not found: ${message}`);
        this.name = "dasha.TtsSpeakerNotFoundError";
    }
}
exports.TtsSpeakerNotFoundError = TtsSpeakerNotFoundError;
class TtsSpeakerCloneWrongFile extends Error {
    constructor() {
        super(`TTS Speaker cloning failed, unsupported file type`);
        this.name = "dasha.TtsSpeakerCloneWrongFile";
    }
}
exports.TtsSpeakerCloneWrongFile = TtsSpeakerCloneWrongFile;
class ProfilerDataFailedError extends Error {
    constructor(request) {
        super(`Error generating profiler data for ${JSON.stringify(request, null, 4)}`);
        this.request = request;
        this.name = "dasha.ProfilerDataFailedError";
    }
}
exports.ProfilerDataFailedError = ProfilerDataFailedError;
