...
class AudioChannel extends eventemitter3_1.default {
    ...
    async _init(clientAccount, options) {
        ...
        const [audioClientId] = await events_1.once(this._connectionStream, "connect");
        this._audioClientId = audioClientId;
        await this._gatewayClient.inviteRequest({
            roomId: "00000000-0000-0000-0000-000000000000",
            additionalInfo,
        });
        const [roomId] = await events_1.once(this._connectionStream, "invite");
        this._roomId = roomId;
